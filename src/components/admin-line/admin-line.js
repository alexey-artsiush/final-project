    ...
    setGames(data)
        ...
        <div className="admine-line" key={id}>
          <div className="admine-line__cart">
            <div className="admine-line__graph">Игра: {title}</div>
            <div className="admine-line__graph">Ссылка на картинку: {image}</div>
            <div className="admine-line__graph">Жанры: {genres}</div>
            <div className="admine-line__graph">Цена: {price}$</div>
            <div className="admine-line__graph">Ссылка на видео: {video}</div>
            <div className="admine-line__graph">Описание игры: {description}</div>
          </div>
          <div className="admine-line__cart-button">
            <Button size="m" onClick={onClick} id={id}>Удалить</Button>
          </div>
